    ...
    <footer className="bg-black text-zinc-400 border-t border-white/10 pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-red-600 to-red-950 flex items-center justify-center border border-red-500/30">
                <span className="font-serif font-black text-white text-base">P</span>
              </div>
            ...
            <p className="text-xs text-zinc-400 leading-relaxed">
              Referência nacional em curadoria, compra e venda de veículos Porsche e superesportivos. Tradição, solidez e paixão pelo automobilismo desde 1993.
            </p>
          ...
          <div className="space-y-3">
            <h4 className="text-xs font-bold uppercase tracking-wider text-white">Unidade & Atendimento</h4>
          ...
          <div className="space-y-4">
            <h4 className="text-xs font-bold uppercase tracking-wider text-white">Atendimento VIP</h4>
            <p className="text-xs text-zinc-400">
              Converse diretamente com nosso consultor especialista para reservas ou agendamento de test-drive.
            </p>
            <a
              href="https://wa.me/5534991610075?text=Ol%C3%A1%2C%20gostaria%20de%20conversar%20com%20um%20consultor%20da%20Ibiza%20Motors."
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-red-600 hover:bg-red-500 text-white font-bold text-xs uppercase tracking-wider transition-colors shadow-lg shadow-red-600/30"
            >
            ...
            <div className="flex items-center gap-3 pt-1 text-zinc-400">
              <a
                href="https://instagram.com/ibizaveiculospatos"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-zinc-500">
          <div>
            © {new Date().getFullYear()} Ibiza Motors Ltda. Todos os direitos reservados. CNPJ: 12.345.678/0001-90.
          </div>
